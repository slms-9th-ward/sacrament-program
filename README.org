...
Keyword arguments:
 - =#:title= :: Optional; defaults to ="Sacrament Meeting Program"=. Title at the top of the program.
...
This is just a helper function that wraps =program-header=.
...
Text argument: Required. Hymn name or number. The renderer will attempt to fetch the name if given the number, or the number given the name. New hymns are in the hymn–number database!
